                        ...
                        <form method="POST" action="{{ route('update_manuBar', $manu->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select form-select-lg mb-3" name="resolution"
                                    ...
                                    @if ($manu->use == 1)
                                        <option value="1" @selected($manu->resolution == 1)>เเถบ 1</option>
                                        <option value="2" @selected($manu->resolution == 2)>เเถบ 2</option>
                                        <option value="3" @selected($manu->resolution == 3)>เเถบ 3</option>
                                    @elseif ($manu->use == 2)
                                        <option value="1" @selected($manu->resolution == 1)>เเถบ 1</option>
                                        <option value="2" @selected($manu->resolution == 2)>เเถบ 2</option>
                                        <option value="3" @selected($manu->resolution == 3)>เเถบ 3</option>
